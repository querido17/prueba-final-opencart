        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4, (0, saveScreen_1.default)(methods, instanceData, folders, tag, saveScreenOptions)];
                case 1:
                    _a = _b.sent(), devicePixelRatio = _a.devicePixelRatio, fileName = _a.fileName, isLandscape = _a.isLandscape;
                    methodCompareOptions = (0, options_1.screenMethodCompareOptions)(checkScreenOptions.method);
                    ...
                    return [2, (0, images_1.executeImageCompare)(methods.executor, executeCompareOptions, true)];
            }
        });
    });
}
